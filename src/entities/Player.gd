...
func start_player_turn():
	for combatant in combatants:
		combatant.set_current_hint(true)
	# Emit a signal or perform other actions to indicate the start of the player's turn
	# You might want to show UI elements, etc.

func choose_combatant_for_action(combatant):
	pass
	# Implement the logic for the player to choose the desired character for the action
	# This can include UI interactions, highlighting, etc.
	# Once the player makes a choice, you can trigger the corresponding action.
func end_player_turn():
	for combatant in combatants:
		combatant.set_current_hint(false)
	# Emit a signal or perform other actions to indicate the end of the player's turn
	# You might want to hide UI elements, etc.
	# Trigger the enemy turn after this.
