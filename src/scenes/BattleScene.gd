...
var level1="res://src/battle_data/battle_test_001.tscn"
var level2="res://src/battle_data/battle_test_002.tscn"
var level3="res://src/battle_data/battle_test_003.tscn"
var level4="res://src/battle_data/battle_test_004.tscn"
var level5="res://src/battle_data/battle_test_005.tscn"
var level6="res://src/battle_data/battle_test_006.tscn"
# Turn count
var turn_count = 0
...
func _ready():
	...
	randomize()
	var new_battle_data_scene: Node
	# Create the enemy position references, delete the scene after retrieving the data
	# (this function should be called externally)
	match difficulty:
		0:new_battle_data_scene = load(level1).instance()
		1:new_battle_data_scene = load(level2).instance()
		2:new_battle_data_scene = load(level3).instance()
		3:new_battle_data_scene = load(level4).instance()
		4:new_battle_data_scene = load(level5).instance()
		5:new_battle_data_scene = load(level6).instance()
		_:get_tree().change_scene("res://src/Main_menu.tscn") 
